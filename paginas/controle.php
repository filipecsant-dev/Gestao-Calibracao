...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> <!-- SOLUÇÃO 1 CARACTERES -->
  <title>Controle Calibração - Norpack</title>
...
<?php 
  ...
  if(listarequipamentoscontrole()){
    ...
    foreach ($listarequipamentos as $l) {
      ...
      if($l->instrumento != 'Controlador de Temperatura' && $l->instrumento != 'Balança' && $l->instrumento != 'Estufa' && $l->instrumento != 'Coef. de Fricção' && $l->instrumento != 'Temporizador'){

          if($l->agendado === '1'){continue;}
...
?>
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines" width="99%">
    ...
    <tbody>
          ...
          <tr class="row5">
            <td class="column0 style67 s style67" colspan="46">Observação: A validade semestral refere-se ao último domingo do sexto mês após a calibração.</td>
         ...
         <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines" width="99%">
          ...
          <tr class="row5">
            <td class="column0 style67 s style67" colspan="46" style="font-size: 14px;">Observações:</td>
            <td class="column46 style4 null"></td>
            <td class="column47 style4 null"></td>
            <td class="column48 style4 null"></td>
            <td class="column49 style4 null"></td>
          ...
          <?php if(listarobs2()){
                    $listarobs2 = listarobs2();
                    foreach ($listarobs2 as $l2) {
                     ?>

          <tr class="row4">
            <td class="column0 style4 null" colspan="46"><?php echo listarnome($l2->id2); ?>: <?php echo $l2->obs; ?></td>
            <td class="column46 style4 null"></td>
            <td class="column47 style4 null"></td>
            <td class="column48 style4 null"></td>
            <td class="column49 style4 null"></td>
